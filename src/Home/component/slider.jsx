...
export const SwipeCarousel = () => {
  ...
  return (
    <div className="relative overflow-hidden backdrop-blur-sm py-8">
      <motion.div
        drag="x"
        dragConstraints={{
          left: 0,
      ...
      {imgs.map((imgSrc, idx) => {
        return (
          <motion.div
            ...
            transition={SPRING_OPTIONS}
            className="aspect-video w-full h-[60vh] shrink-0 rounded-xl  object-cover object-center"
          />
        );
      })}
    </>
        ...
        return (
          <button
            ...
            className={`h-3 w-3 rounded-full transition-colors ${
              idx === imgIndex ? "bg-primaryCol" : "bg-secondaryCol"
            }`}
          />
        );
      })}
